...
class ClassRoomRepository {
  ...
  Future<void> addClassRoom(
    ...
    final effectiveTeacherName = teacherName ??
        classRoom.teacherName ??
        await _teacherNameById(effectiveTeacherId) ??
        '';
  ...
  Future<String?> _teacherNameById(String teacherId) async {
    if (teacherId.trim().isEmpty) return null;
    final teachers = await getTeachers();
    for (final teacher in teachers) {
      if (teacher.id == teacherId) return teacher.fullName;
    }
    return null;
  }
