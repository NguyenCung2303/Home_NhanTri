  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _NavItem(icon: Icons.space_dashboard_rounded, label: 'Tổng quan', active: currentIndex == 0, onTap: () => onChanged(0)),
          _NavItem(icon: Icons.groups_rounded, label: 'Lớp học', active: currentIndex == 1, onTap: () => onChanged(1)),
          _NavItem(icon: Icons.event_available_rounded, label: 'Điểm danh', active: currentIndex == 2, onTap: () => onChanged(2)),
          _NavItem(icon: Icons.event_note_rounded, label: 'Lịch học', active: currentIndex == 3, onTap: () => onChanged(3)),
          _NavItem(icon: Icons.assignment_ind_rounded, label: 'Đăng ký', active: currentIndex == 4, onTap: () => onChanged(4)),
          _NavItem(icon: Icons.checklist_rounded, label: 'To-Do', active: currentIndex == 5, onTap: () => onChanged(5)),
          _NavItem(icon: Icons.account_circle_rounded, label: 'Cá nhân', active: currentIndex == 6, onTap: () => onChanged(6)),
        ],
      ),
    );
  }
